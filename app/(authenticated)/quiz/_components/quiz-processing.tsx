    ...
    <div className="min-h-dvh flex flex-col items-center justify-center p-6 animate-fade-in">
      <div className="text-center space-y-8">
        ...
        <div className="relative w-32 h-32 mx-auto">
          ...
          <div
            className="absolute inset-3 rounded-full border-2 border-transparent border-t-violet-500 animate-spin"
          ...
          <div
            className="absolute inset-6 rounded-full border-2 border-transparent border-t-emerald-500 animate-spin"
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm sm:text-base max-w-sm mx-auto">
            Our AI is analyzing your answers and generating your placement results...
          </p>
        </div>
